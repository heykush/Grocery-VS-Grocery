...
driver = webdriver.Chrome(
    r"C:\Users\gkush\Downloads\Compressed\chromedriver_win32\chromedriver.exe"
)
...
sleep(2)
loc = driver.find_element_by_xpath("//*[@class='btn location-box mask-button']").click()
sleep(5)
mainlinks = []
pplink = []
aa = []
...
sublist = []
hrefsa = []
for link in categories.find_all("a", href=True)[2:21]:
    ...
    for b in itemlist:
        ...
        for z in hrefs:
            ...
            for m in subitemlist:
                catename = driver.find_element_by_class_name("category-item-details")
                ...
                for x in hrefsa:
                    ...
                    for u in productgroup:
                        ...
                        for p in product:
                            ...
                            pp = p.find_elements_by_class_name("plp-product__quantity")
                            for v in pp:
                                ppp = v.text
                                xx.append(ppp)
